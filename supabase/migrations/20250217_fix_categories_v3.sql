-- ============================================
-- EMERGENCY FIX v3: Update categories without NULL
-- Column has NOT NULL constraint!
-- ============================================

-- 1. First, let's see current broken state
SELECT 'CURRENT BROKEN STATE' as info;
SELECT 
  category,
  COUNT(*) as count
FROM vacancies
...
-- 2. Set ALL to 'Другое' first (safe operation)
UPDATE vacancies SET category = 'Другое';

-- 3. Now update specific categories one by one
-- IT Category (MOST IMPORTANT - should have ~800-1000)
UPDATE vacancies
SET category = 'ИТ'
...
-- Those that remain as 'Другое' stay as 'Другое'
